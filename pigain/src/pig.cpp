...
PIG::PIG(ros::NodeHandle& nh)
  ...
  , reevaluate_client_(nh_.serviceClient<stl_aeplanner_msgs::Reevaluate>("reevaluate"))
...
bool PIG::bestNodeCallback(stl_aeplanner_msgs::BestNode::Request& req, stl_aeplanner_msgs::BestNode::Response& res)
{
...
void PIG::gainCallback(const stl_aeplanner_msgs::Node::ConstPtr& msg)
{
...
void PIG::reevaluateCallback(const ros::TimerEvent& event)
{
  ...
  stl_aeplanner_msgs::Reevaluate srv;
