...
struct Node
{
  ...
  Node(const stl_aeplanner_msgs::Node& node)
...
private:
  bool gpQueryCallback(stl_aeplanner_msgs::Query::Request& req, stl_aeplanner_msgs::Query::Response& res);

  bool bestNodeCallback(stl_aeplanner_msgs::BestNode::Request& req, stl_aeplanner_msgs::BestNode::Response& res);

  void gainCallback(const stl_aeplanner_msgs::Node::ConstPtr& msg);
